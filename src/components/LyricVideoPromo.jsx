      ...
      >
        <div>
          <h2 style={{ marginTop: 0, marginBottom: 8 }}>
            🎬 Personalized Lyric Video —{" "}
            <span style={{ fontWeight: 800 }}>$20</span>
          </h2>

          <p className="muted" style={{ marginTop: 0 }}>
            Your lyrics synchronized on a beautiful video — perfect for gifts,
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            <button
              ...
              onClick={handleClick}
              style={{
                backgroundColor: selected ? "#16a34a" : "#1e3a8a", // green / dark blue
                color: "#ffffff",
                border: "none",
                transition: "background-color 0.25s ease",
              }}
            >
              {selected ? "✔ Lyric Video Selected" : "Choose Lyric Video ($20)"}
            </button>
